...
> 当前活跃：`v5.0.0-alpha.8`（`docs/changelog.md`），最新复核为 `docs/defect-recheck-2026-09-06.md`（76 条 v2 对质版）与 `docs/updater-audit-2026-09-05.md`（更新子系统 v2，通道 Stable/Prerelease/All + `update/last_check.json`）。
...
- **必修（P0，9 条）**：见 `docs/defect-recheck-2026-09-06.md` §二（Bridge 槽位/取消注册表、录制器多 frame、任务创建 `..Default` 空 steps 等）。
...
- **更新子系统（4 项 P2 + 3 项 P3）**：见 `docs/updater-audit-2026-09-05.md` 分批建议（A 正确性：base 分离与 helper 落点；B 体验：停滞超时与配额 403/429；C 接口：pin 版本闸门；D 清理：double-fire 与 `available` 语义）。
...
- `docs/test-coverage-2026-08-30.md` 重定向下版本可删。
