# 待办清单（TODO）[已归档 2026-08-27]

> 已归档 — 本文件所列批次一~八与 2026-08-15 全面审查 P0/P1/P2 已全部完成并在 `docs/changelog.md` 归档，无活跃任务。活跃入口见 `docs/known-issues.md` 与 `docs/changelog.md`。
> 原路径 `docs/todo.md` 已替换为 stub。
